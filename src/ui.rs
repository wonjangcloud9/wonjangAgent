...
const TIPS: &[&str] = &[
    ...
    "💡 오늘의 팁: 월급날까지 며칠? → wonjang 월급날 25",
    "💡 오늘의 팁: 세금계산서 사업자번호 맞나? → wonjang 사업자번호 124-81-00998",
    "💡 오늘의 팁: 개인사업자 종합소득세 얼마? → wonjang 종소세 5000만",
    "💡 오늘의 팁: 자녀에게 증여세 얼마? → wonjang 증여세 5억 자녀",
    "💡 오늘의 팁: 최저가 한 번에 비교 → wonjang 최저가 에어팟 --열기",
    "💡 오늘의 팁: 3.3% 떼면 실수령 얼마? → wonjang 원천징수 100만",
    "💡 오늘의 팁: 법정 상속분 어떻게 나눠? → wonjang 상속 7억 --배우자 --자녀 2",
    "💡 오늘의 팁: 받을 돈 소멸시효 언제? → wonjang 소멸시효 2020-01-01 상사",
    "💡 오늘의 팁: 이 이자 합법일까? → wonjang 최고금리 100만 5만 1",
    "💡 오늘의 팁: 캡처 여러 장을 움짤로 → wonjang 움짤 1.png 2.png 3.png --초 0.5",
    "💡 오늘의 팁: 이번 주 날씨·비올확률 → wonjang 주간날씨 서울",
    "💡 오늘의 팁: 전역까지 며칠? 카드로 자랑 → wonjang 전역 2025-03-04 육군 --카드",
    "💡 오늘의 팁: 결혼기념일·생신 매년 챙기기 → wonjang 디데이 추가 \"결혼기념일\" 2020-05-20 --매년",
